...
<head>
    ...
    <link rel="stylesheet" href="inscri.css"> <!--Link CSS-->
...
<body>
    ...
    <div class="container">
        ...
        <form action="authentifi.php" method="POST">
            ...
            <button type="submit" class="btn" name="submit" id="btn" disabled>CRÉER VOTRE COMPTE</button>
            <div class="line"></div>
...
<!-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-pprn3073KE6tl6bjs2QrFaJGz5/SUsLqktiwsUTF55Jfv3qYSDhgCecCxMW52nD2" crossorigin="anonymous"></script> Script bootstrap -->
